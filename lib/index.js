...
const STATE_DIR_NAME = 'dsh-remote-mesh'
...
const TOKEN_HEADER = 'x-dsh-remote-mesh-token'
...
function writeTunnelFailure(socket, what, error) {
  ...
  const body = [
    ...
    '</ol>',
    '<p style="color:#71717a">本页面由 dsh-remote-mesh 生成。</p></body>',
  ].join('')
  try {
    socket.end(
